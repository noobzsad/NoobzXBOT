...
exports.noregis = () => {
	return`*「 PENDAFTARAN 」*\n\n*Cara daftar ${prefix}daftar nama|umur* \n*contoh ${prefix}daftar NoobzX|22*`
}
...
exports.bug = () => {
	return`*Masalah telah di laporkan ke owner KAWAI, Laporan palsu atau main² tidak akan ditanggapi.*`
}
...
exports.limitend = (pushname) => {
	return`*Maaf ${pushname} limit hari ini habis*\n*Hubungi kami* : wa.me/6285755375996\n\n*Note : Kami akan berikan random dari 1-10*`
}
